# Autogenerated wrapper script for gdk-pixbuf_jll for x86_64-apple-darwin14
export libgdkpixbuf
...
const libgdkpixbuf_splitpath = ["lib", "libgdk_pixbuf-2.0.0.dylib"]
...
const libgdkpixbuf = "@rpath/libgdk_pixbuf-2.0.0.dylib"
